...
if not exist "%WXWIN%" (
  ...
  if  "%~1"=="wx32" (
      ...
      wget -nv --no-check-certificate !GITHUB_DL!/v3.2.1/wxMSW-3.2.8_vc14x_Dev.7z
      7z x -o%SCRIPTDIR%..\cache\wxWidgets-3.2.8 wxMSW-3.2.1_vc14x_Dev.7z
      wget -nv --no-check-certificate !GITHUB_DL!/v3.2.1/wxWidgets-3.2.8-headers.7z
      7z x -o%SCRIPTDIR%..\cache\wxWidgets-3.2.8 wxWidgets-3.2.1-headers.7z
  ) else (
