...
elseif($ENV{TRAVIS})
    ...
    #message(STATUS "TRAVIS_REPO_SLUG: $ENV{TRAVIS_REPO_SLUG}, ${TRAVIS_REPO_SLUG}")
    #message(STATUS "TRAVIS_PULL_REQUEST_SLUG: $ENV{TRAVIS_PULL_REQUEST_SLUG}, ${TRAVIS_PULL_REQUEST_SLUG}")
elseif($ENV{APPVEYOR})
...
if("${GIT_REPOSITORY}" STREQUAL "")
    ...
    string(REGEX REPLACE ".git" "" GIT_REPOSITORY_URL ${GIT_REPOSITORY_URL})
