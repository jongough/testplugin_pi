...
if(DEFINED ENV{OCPN_TARGET})
    ...
    if(OCPN_FLATPAK_CONFIG OR OCPN_FLATPAK_BUILD OR MINGW OR MSVC OR
        ...
        (("$ENV{OCPN_TARGET}" STREQUAL "bullseye-armhf" OR "$ENV{OCPN_TARGET}" STREQUAL "bullseye-arm64") AND "$ENV{BUILD_ENV}" STREQUAL "debian") OR
        (("$ENV{OCPN_TARGET}" STREQUAL "buster-armhf" OR "$ENV{OCPN_TARGET}" STREQUAL "buster-arm64") AND "$ENV{BUILD_ENV}" STREQUAL "debian"))
