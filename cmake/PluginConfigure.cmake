...
if (DEFINED ENV{OCPN_TARGET})
  ...
  if (OCPN_FLATPAK_CONFIG
    ...
    if (APPLE AND CMAKE_OSX_ARCHITECTURES)
      set(PACKAGING_NAME
          "${PKG_NVR}-$ENV{OCPN_TARGET}-${PKG_TARGET}-${PKG_TARGET_VERSION}${PKG_BUILD_GTK}"
      )
      set(PACKAGING_NAME_XML
          "${PKG_NVR}-$ENV{OCPN_TARGET}-${PKG_TARGET}-${COMPOUND_ARCH_DASH}-${PKG_TARGET_VERSION}${PKG_BUILD_GTK}"
      )
    else ()
      set(PACKAGING_NAME
