...
message(STATUS "Package: OCPN_FLATPAK: ${OCPN_FLATPAK}")
...
if(OCPN_FLATPAK)
  ...
  add_custom_target(
    ...
    COMMAND /usr/bin/flatpak-builder --force-clean ${CMAKE_CURRENT_BINARY_DIR}/app org.opencpn.OpenCPN.Plugin.${PACKAGE}.yaml)
